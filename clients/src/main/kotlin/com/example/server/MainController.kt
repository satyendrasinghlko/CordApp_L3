...
class MainController(rpc: NodeRPCConnection) {
    ...
    fun createIOU(request: HttpServletRequest): ResponseEntity<String> {
        ...
        val amount = Double.parseDouble(request.getParameter("amount"))
        ...
        return try {
            val signedTx = proxy.startTrackedFlow(::Initiator, otherParty,amount,Date(),status).returnValue.getOrThrow()
